...
public interface Runner {
     ...
     * for bean instantiation and execution by the {@link runtimeSE} system.
    ...
    /**
     * Method {@code run} is called by the {@link runtimeSE} system after
     * instantiation of a class that implements this interface.
     * @param args arguments passed from the command line.
     */
    void run(RuntimeSE runtime, String[] args);
}
